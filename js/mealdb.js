...
const searchFood = () => {
    ...
    searchField.value = '';
    if (searchText == '') {
        console.log('please write something word ')
    }
    else {
        ...
        fetch(url)
            ...
            .catch(error => displaySearchReult(error));
...
const displaySearchReult = error => {
...
const displaySearchResult = meal => {
    ...
    meal.forEach(meals => {
        ...
        div.innerHTML = `
        <div  onclick ="loadmealDetails(${meals.idMeal})"class="card">
